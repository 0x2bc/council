...
- Create GitHub Page. Use the following title format: weekly_summary_02-Dec-2023.md where the mentioned date is final date of report period
...
- Go to [Weekly Roundup Figma File](https://www.figma.com/file/5YhZb4BvDdsG3aUetW2S8u/Weekly-Roundup?type=design&mode=design&t=zw6oTyQjCDpLlxmL-1)
- Copy the page into your Figma space
- Adjust the dates to match the current reporting period
- Export the updated image
- Update the headline image in the GitHub report page 

### Update Report Data with Reporting Automation Script

- Access Reporting Tool https://report.joyutils.org
- Go to 'Weekly Report Data' item
- Select the week for report generation
- Enable 'Storage Status' checkbox
...
- Obtain clear approval from the Council for publishing of Weekly Report
