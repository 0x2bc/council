...
| Task name | Priority | Description |  Links |
| --- | --- | --- | --- |
| Budget optimisation #1 | Critical | Approve EMA30 cap |  |
| Budget optimisation #2 | Critical | Reassess all WG salaries and scope of work. Identify opportunities for budget optimization, including the possibility of shifting lead salaries to a bonus-based system. Under this system, leads would earn rewards based on achievements rather than receiving constant term-by-term rewards.  |  |
| Budget optimisation #3 | Critical | Change SWG per worker allocation from 650 USD-EMA30 to 550 USD-EMA30;  DWG from 550 to 450 USD-EMA30 |  |
| CWG group update | Critical | Revise the CWG scope; Explore the option of appointing a new CWG lead, as Dmtr's availability will be significantly reduced |  |
| Argo Bridge #1: AMM params | Critical | Approve parameters for Argo AMM, including fees for the pool, liquidity levels, and liquidity amounts. |  |
| Argo Bridge #2:  pausers list  | Critical | Approve the set of pausers for the Argo Bridge on BASE and ETH. |  |
| Q3 2024 OKRs #1 | Critical | Reassess the prioritization of future developments based on our current resources, the potential impact of these developments on MCAP and PMF, and the latest discussions on this topic |  |
| Q3 2024 OKRs #2 | Critical | Monitor progress and take necessary adjustment actions if needed | https://www.notion.so/Q3-2024-OKRs-9a66296dc36b415582c740502e4c4a20?pvs=21 |
| Accounting #1: Improve transparency of DAO spendings | High | Come up with requirements for the accounting system and tools that will enhance accountability and transparency in DAO budgeting; Agree and budgets and timelines | https://pioneer.joyutils.org/#/forum/thread/960 |
| Accounting #2: Improve visibility of lead rewards being vested | High | Improve visibility of lead rewards being vested | https://www.notion.so/Improve-visibility-of-lead-rewards-being-vested-475dd2a63d354c6088f41134f03cdf90?pvs=21 |
| Connect the DAO to the Internet | Low | Needs builders WG appraisal for cost/effort and should be discussed during roadmap call | https://www.notion.so/Connect-the-DAO-to-the-Internet-7cfddeec939344f0a2b95d38f8644bcc?pvs=21, https://pioneerapp.xyz/#/forum/thread/908 |
